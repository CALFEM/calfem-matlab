function [Ke,Me,fe]=aco2i8d(ex,ey,ep,eq)
% Ke=aco2i8d(ex,ey,ep)
% [Ke,fe]=aco2i8d(ex,ey,ep,eq)
%-----------------------------------------------------------
% PURPOSE
%  Compute element stiffness and mass  
%  matrix for 8 node isoparametric acoustic element
%
...
Ke=c*c*t*Ke1;  Me=t*Me1;  fe=fe1*t*c*c*raa*eq;
%-------------------------- end -------------------------------
